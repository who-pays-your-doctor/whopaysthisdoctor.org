...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Doctor.gmc_number'
        db.alter_column(u'doctors_doctor', 'gmc_number', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Doctor.gmc_number'
        raise RuntimeError("Cannot reverse this migration. 'Doctor.gmc_number' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Doctor.gmc_number'
        db.alter_column(u'doctors_doctor', 'gmc_number', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True))
    ...
    models = {
        ...
        u'doctors.declarationlink': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'a7e78a84'", 'unique': 'True', 'max_length': '64'})
        },
        u'doctors.doctor': {
            'Meta': {'object_name': 'Doctor'},
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'employment_address': ('django.db.models.fields.TextField', [], {}),
            'gmc_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
